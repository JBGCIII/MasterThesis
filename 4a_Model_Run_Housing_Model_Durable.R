###############################################################################
###################### HOUSING TRANSMISSION MODEL - DURABLE ##################
###############################################################################
#                           [1] MODEL SET UP
# 1. Load up data
...
#                               Model 1 (p = 1)
#------------------------------------------------------------------------------#
spec_housing_one_durable <- specify_bsvarSIGN$new(
  data         = housing_data,          
  p            = 1,                     
  sign_irf     = sign_irf,              
...
#                               Model 2 (p = 2)
#------------------------------------------------------------------------------#
spec_housing_two_durable <- specify_bsvarSIGN$new(
  data         = housing_data,         
  p            = 2,                    
  sign_irf     = sign_irf,              
  stationary   = is_stationary,          
...
#                               Model 3 (p = 3)
#------------------------------------------------------------------------------#
spec_housing_three_durable <- specify_bsvarSIGN$new(
  data         = housing_data,          
  p            = 3,                     
  sign_irf     = sign_irf,              
  stationary   = is_stationary,          
...
#                               Model 4 (p = 4) 
#------------------------------------------------------------------------------#
spec_housing_four_durable <- specify_bsvarSIGN$new(
  data         = housing_data,         
  p            = 4,                     
  sign_irf     = sign_irf,              
  stationary   = is_stationary,        
...
#                               Model 5 (p = 5) 
#------------------------------------------------------------------------------#
spec_housing_five_durable <- specify_bsvarSIGN$new(
  data         = housing_data,         
  p            = 5,                     
  sign_irf     = sign_irf,              
  stationary   = is_stationary,        
...
spec_housing_one_durable$estimate_hyper(S = 5000, burn_in = 1000)
spec_housing_two_durable$estimate_hyper(S = 5000, burn_in = 1000)
spec_housing_three_durable$estimate_hyper(S = 5000, burn_in = 1000)
spec_housing_four_durable$estimate_hyper(S = 5000, burn_in = 1000)
spec_housing_five_durable$estimate_hyper(S = 5000, burn_in = 1000)

#=============================================================================#
#                          [5] RUN MODEL

estimate_housing_durable_1 <- estimate(spec_housing_one_durable, S = 4000, thin = 1)
estimate_housing_durable_2 <- estimate(spec_housing_two_durable, S = 4000, thin = 1)
estimate_housing_durable_3 <- estimate(spec_housing_three_durable, S = 4000, thin = 1)
estimate_housing_durable_4 <- estimate(spec_housing_four_durable, S = 4000, thin = 1)
estimate_housing_durable_5 <- estimate(spec_housing_five_durable, S = 4000, thin = 1)

#=============================================================================#
#                          [6] SAVE ESTIMATED MODELS
#=============================================================================#

dir.create("3_Model_Output/Model_Housing/Durable", recursive = TRUE, showWarnings = FALSE)

saveRDS(estimate_housing_durable_1, file = "3_Model_Output/Model_Housing/Durable/housing_durable_p1.rds")
saveRDS(estimate_housing_durable_2, file = "3_Model_Output/Model_Housing/Durable/housing_durable_p2.rds")
saveRDS(estimate_housing_durable_3, file = "3_Model_Output/Model_Housing/Durable/housing_durable_p3.rds")
saveRDS(estimate_housing_durable_4, file = "3_Model_Output/Model_Housing/Durable/housing_durable_p4.rds")
saveRDS(estimate_housing_durable_5, file = "3_Model_Output/Model_Housing/Durable/housing_durable_p5.rds")

#=============================================================================#
#                          [7] STABILITY DIAGNOSTIC
#=============================================================================#

ev_one   <- check_posterior_stability(estimate_housing_durable_1, p = 1)
ev_two   <- check_posterior_stability(estimate_housing_durable_2, p = 2)
ev_three <- check_posterior_stability(estimate_housing_durable_3, p = 3)
ev_four  <- check_posterior_stability(estimate_housing_durable_4, p = 4)
ev_five  <- check_posterior_stability(estimate_housing_durable_5, p = 5)
...
write.csv(stability_diagnostics, file = "3_Model_Output/Model_Housing/Durable/posterior_stability_summary.csv", row.names = FALSE)
