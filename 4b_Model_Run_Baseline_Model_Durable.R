...
spec_baseline_one_durable <- specify_bsvarSIGN$new(
  data         = domestic_data,          
  p            = 1,                     
  sign_irf     = sign_irf,               
...
spec_baseline_two_durable <- specify_bsvarSIGN$new(
  data         = domestic_data,         
  p            = 2,                   
  sign_irf     = sign_irf,               
  stationary   = is_stationary,          
...
spec_baseline_three_durable <- specify_bsvarSIGN$new(
...
spec_baseline_four_durable <- specify_bsvarSIGN$new(
  data         = domestic_data,         
  p            = 4,                      
  sign_irf     = sign_irf,              
  stationary   = is_stationary,        
...
spec_baseline_five_durable <- specify_bsvarSIGN$new(
  data         = domestic_data,         
  p            = 5,                      
  sign_irf     = sign_irf,              
  stationary   = is_stationary,        
...
spec_baseline_one_durable$estimate_hyper(S = 5000, burn_in = 1000)
spec_baseline_two_durable$estimate_hyper(S = 5000, burn_in = 1000)
spec_baseline_three_durable$estimate_hyper(S = 5000, burn_in = 1000)
spec_baseline_four_durable$estimate_hyper(S = 5000, burn_in = 1000)
spec_baseline_five_durable$estimate_hyper(S = 5000, burn_in = 1000)


#=============================================================================#
#                          [5]  RUN MODEL

estimate_baseline_durable_1 <- estimate(spec_baseline_one_durable, S = 4000, thin = 1)
estimate_baseline_durable_2 <- estimate(spec_baseline_two_durable, S = 4000, thin = 1)
estimate_baseline_durable_3 <- estimate(spec_baseline_three_durable, S = 4000, thin = 1)
estimate_baseline_durable_4 <- estimate(spec_baseline_four_durable, S = 4000, thin = 1)
estimate_baseline_durable_5 <- estimate(spec_baseline_five_durable, S = 4000, thin = 1)
...
dir.create("3_Model_Output/Model_Baseline/Durable", recursive = TRUE, showWarnings = FALSE)


saveRDS(estimate_baseline_durable_1, file = "3_Model_Output/Model_Baseline/Durable/baseline_durable_p1.rds")
saveRDS(estimate_baseline_durable_2, file = "3_Model_Output/Model_Baseline/Durable/baseline_durable_p2.rds")
saveRDS(estimate_baseline_durable_3, file = "3_Model_Output/Model_Baseline/Durable/baseline_durable_p3.rds")
saveRDS(estimate_baseline_durable_4, file = "3_Model_Output/Model_Baseline/Durable/baseline_durable_p4.rds")
saveRDS(estimate_baseline_durable_5, file = "3_Model_Output/Model_Baseline/Durable/baseline_durable_p5.rds")
...
ev_two <- check_posterior_stability(estimate_baseline_durable_2, p = 2)
ev_three   <- check_posterior_stability(estimate_baseline_durable_3, p = 3)
ev_four <- check_posterior_stability(estimate_baseline_durable_4, p = 4)
